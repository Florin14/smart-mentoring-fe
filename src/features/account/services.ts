...
export const fetchUserCall = async (): Promise<AxiosResponse<UserDto>> => axiosInstance.get('/users/profile')

export const updateUserCall = async (usersFormData: ProfileSubmitType): Promise<AxiosResponse<UserDto>> =>
...
export const fetchCompletedStudiesOptionsCall = async (): Promise<AxiosResponse<Study[]>> =>
  axiosInstance.get('/studies')

export const fetchInterestAreasOptionsCall = async (): Promise<AxiosResponse<InterestArea[]>> =>
  axiosInstance.get('/interest-areas')

export const fetchStudentsCall = async (): Promise<AxiosResponse<BaseUser[]>> =>
